 ...
 * ADVANCED TOPIC
 *
 * Provides utility methods to create C3P0 connection pool, retrieve connection
 * and to shutdown the connection pool.
 *
 * @author Mike Prasad
 */
...
public class JDBCConnectionPoolManager {
  ...
  public static void createPool() throws ConnectionPoolCreationException {
    ...
    try {
      ...
      log.info(pve.getClass() + ": " + pve.getMessage());
      StringWriter errors;
    ...
    log.info("-Connection Pool creation completed");
  }
  ...
  public static Connection getConnection() {
    ...
    try {
      ...
      //replace with log4 logging
      //log.error  (sqe.getClass()+": "+ sqe.getMessage(), sqe);	
      log.info(sqe.getClass() + ": " + sqe.getMessage());
      StringWriter errors;
